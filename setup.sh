...
echo "✅ Done. Building..."
pnpm build && git add . && git commit -m "🎯 30yr marketer rewrite

- New headline: transformation-led not feature-led
- Urgency pill above the fold — scarcity signal
- Hero trust strip: 3 proof points near the CTA
- UrgencyBar: black bg, bold numbers, sub-labels
- About: pain-point lead copy before solution
- NEW InvestmentCase section: 4 cards — numbers, location, risk, timing
- Features: feature + benefit columns — not just bullets
- Payment: anchoring — lead with smallest number (2,20,000)
- Chairman: personalised quote, reputation framing
- CTA Banner: loss aversion headline — every month you wait price goes up
- Contact: one call one decision — human, not corporate" \
